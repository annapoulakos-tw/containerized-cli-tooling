...
assert_contains "${repo_root}/zsh-autoload-funcs/ai-cli" '--label "ai-team.managed=true"'
assert_contains "${repo_root}/zsh-autoload-funcs/ai-cli" '--label "ai-team.worker-id=${workstream_id}"'
assert_contains "${repo_root}/zsh-autoload-funcs/ai-cli" '--env "AI_WORKSTREAM_ID=${workstream_id}"'
